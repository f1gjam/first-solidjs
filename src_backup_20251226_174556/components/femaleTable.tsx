...
export async function fetchData(selectedDate: string) {
    ...
    let apiUrl = `${API_BASE_URL}/dataapi/rider_totals?${params}`;
    console.log(apiUrl);
    ...
    return (
        <>
            <div className="shadow-lg rounded-lg overflow-hidden mx-4 my-4 sm:mx-4 sm:my-4" >
                <h2 className="text-2xl font-bold p-4">Womens Cycling Leaderboard</h2>
            ...
            <div className="mx-4 my-8">
                <h2 className="text-2xl font-bold mb-6 text-gray-800">Top 10 Rankings</h2>
