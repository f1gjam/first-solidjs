...
export function WomensRunningYearly() {
        ...
        <div className="min-h-screen bg-gray-50">
            <div className="container mx-auto px-4 py-8">
                <div className="bg-gradient-to-r from-pink-600 to-pink-800 rounded-lg shadow-lg p-8 mb-8 text-white">
                    <h1 className="text-4xl font-bold mb-2">🏃‍♀️ Women's Running - Yearly Leaderboard</h1>
                    <p className="text-pink-100 text-lg">Year-to-date running achievements and rankings</p>
                </div>

                <div className="shadow-lg rounded-lg overflow-hidden mx-4 my-4 sm:mx-4 sm:my-4 bg-white" >
                    <h2 className="text-2xl font-bold p-4">Women's Running Yearly Leaderboard</h2>
